        ...
        return {
            object: {
                text: [
                    ...
                    <br>
                    Технологическая основа проекта — <strong>JavaFX</strong> , которая позволила реализовать высоконадежное и гибкое решение с учётом всех требований безопасности.              
                    `, 
                    ...
                    <br>
                    Разработка выполнена с использованием технологии <strong>Java Android</strong>, что обеспечивает удобство работы на мобильных устройствах и возможность использования программы в любом месте склада.
                    `,
